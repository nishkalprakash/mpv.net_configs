...
bind_command('disable-ui', function() options.proximity_in = 40;options.proximity_out = 41; end)
bind_command('enable-ui', function() options.proximity_in = 10000;options.proximity_out = 10001; end)
bind_command('permanent-ui', function() options.proximity_in = 10000;options.proximity_out = 10001; end)
